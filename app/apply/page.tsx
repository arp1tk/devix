...
import { ArrowRight, Upload, Code, Server, BookOpen, Users, Briefcase, CheckCircle, RefreshCw } from "lucide-react"
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        id="experience"
                        name="experience"
                        placeholder="Describe any relevant projects, coursework, or previous experience"
                  ...
                  <div className="space-y-6">
                    <div className="space-y-2">
                      <Label htmlFor="whyJoin" className="text-slate-200">
                        Why do you want to join? <span className="text-indigo-400">*</span>
                      </Label>
                      <Textarea
                        id="whyJoin"
                        name="whyJoin"
                        placeholder="Tell us why you're interested in this position and what you hope to gain from it"
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        required
                      />
                      <Label htmlFor="agreeTerms" className="text-slate-300">
                        I agree to the terms and conditions <span className="text-indigo-400">*</span>
                      </Label>
                    </div>
                  </div>
                </div>
